...
try {
 ...
 String query = "SELECT SNS_TYPE, STOCK_NAME, STOCK_CODE, REG_DT, READ_CNT, TITLE,WRITER,CONTENT_URL FROM STEAMSTOCK.KOSDAQ_BOARD WHERE STOCK_CODE = '"+stock_code+"' ORDER BY reg_dt desc limit 100;";
