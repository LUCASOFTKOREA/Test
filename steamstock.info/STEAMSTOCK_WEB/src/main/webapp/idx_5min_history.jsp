...
<title>Kospi 종목별 SteamStock 지수</title>
...
try {
 ...
 String query = "SELECT STOCK_CODE, HOUR, 5MIN, 5MIN_IDX, format(5MIN_READ_CNT,0) AS 5MIN_READ_CNT, format(5MIN_IDX*5MIN_READ_CNT,0) AS ST_IDX, STOCK_PRICE_TODAY, STOCK_PRICE_RATE_TODAY FROM STEAMSTOCK.STOCK_IDX_5MIN_HISTORY WHERE STOCK_CODE = '"+stock_code+"' AND DATE = '"+search_date+"' ORDER BY UPDATE_DATETIME DESC";
...
<a href="/idx_5min_history_chart.jsp?stock_code=<%=stock_code%>&stock_name=<%=stock_name%>">챠트]</a></STRONG><br><br> 
...
<STRONG><a href="https://finance.naver.com/item/board.nhn?code=<%=stock_code%>">[Naver종토방&nbsp;|&nbsp;</a> 
<a href="https://finance.daum.net/quotes/A<%=stock_code%>#talks">Daum종토방&nbsp;|&nbsp;</a>
<a href="/idx_5min_history_chart.jsp?stock_code=<%=stock_code%>&stock_name=<%=stock_name%>">챠트보기]</a></STRONG><br><br> 
