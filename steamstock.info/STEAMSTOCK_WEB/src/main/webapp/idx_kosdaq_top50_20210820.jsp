...
<title>SteamStock Kosdaq 지수 TOP50</title>
...
<STRONG>Kosdaq 스팀스탁지수 TOP50(5분간격 실시간 데이터) <%=search_date%></STRONG>
...
<td> <a href="/idx_kosdaq_5min_history.jsp?stock_code=<%= rs.getString("STOCK_CODE")%>&stock_name=<%=rs.getString("STOCK_NAME")%>">5분보기</a> </td>
<td> <a href="/board_kosdaq.jsp?stock_code=<%= rs.getString("STOCK_CODE")%>&stock_name=<%=rs.getString("STOCK_NAME")%>">최신글보기</a> </td>
<td> <a href="/board_kosdaq_top.jsp?stock_code=<%= rs.getString("STOCK_CODE")%>&stock_name=<%=rs.getString("STOCK_NAME")%>">인기글보기</a> </td>
</tr>
<%	
}
%>
