...
<STRONG>Kospi통계 - 스팀스탁지수 TOP50(5분간격 실시간 데이터) <%=search_date%></STRONG>
</td>
</tr>
<td colspan="9">
&nbsp;
...
<td align="center"> <a href="/idx_5min_history.jsp?stock_code=<%= rs.getString("STOCK_CODE")%>&stock_name=<%=rs.getString("STOCK_NAME")%>">5분보기</a> </td>
