...
ResultSet rs = null;
 ...
 String query = "SELECT 'KOSPI' AS MARKET, STOCK_NAME,STOCK_CODE,IDX_NOW,5MIN_READ_CNT, cast(5MIN_READ_CNT as unsigned)*cast(idx_now as unsigned) as ST_IDX FROM STEAMSTOCK.STOCK_IDX union all SELECT 'KOSDAQ' AS MARKET, STOCK_NAME,STOCK_CODE,IDX_NOW,5MIN_READ_CNT, cast(5MIN_READ_CNT as unsigned)*cast(idx_now as unsigned) as ST_IDX FROM STEAMSTOCK.KOSDAQ_IDX ORDER BY cast(5MIN_READ_CNT as unsigned)*cast(idx_now as unsigned) desc limit 5";
