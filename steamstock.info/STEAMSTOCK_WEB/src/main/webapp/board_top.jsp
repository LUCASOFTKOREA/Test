...
System.out.println("page board_top.jsp start!!!");
...
try {
 ...
 String query = "SELECT SNS_TYPE, STOCK_NAME, STOCK_CODE, REG_DT, READ_CNT, TITLE,WRITER,CONTENT_URL FROM STEAMSTOCK.STOCK_BOARD_20210810 WHERE STOCK_CODE = '"+stock_code+"' AND LEFT(REG_DT,10)=DATE_FORMAT(DATE_ADD(NOW(), INTERVAL 9 HOUR),'%Y.%m.%d') ORDER BY read_cnt desc limit 100;";
 rs = stmt.executeQuery(query); 
 //////////////////////////////////////
 
%>
<STRONG><a href="/">Home</a></STRONG>&nbsp;|&nbsp;
<STRONG><%=request.getParameter("stock_name")%> 인기 게시판(100건) <%=search_date %></STRONG>
